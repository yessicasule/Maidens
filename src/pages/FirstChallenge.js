...
import SecondChallenge from "./SecondChallenge"; // Import Level 2 component
...
export default function FirstChallenge() {
  ...
  const [unlockedLevels, setUnlockedLevels] = useState([1]); // Track unlocked levels
  ...
  const handleNextChallenge = () => {
    setCurrentLevel(2); // Move to Level 2
    setUnlockedLevels([1, 2]); // Unlock Level 2
  };
